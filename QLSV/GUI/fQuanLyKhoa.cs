...
namespace QLSV
{
    public partial class fQuanLyKhoa : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (makhoa.Length == 0 && tenkhoa.Length == 0)
                 DialogResult = MessageBox.Show("Vui lòng nhập đầy đủ thông tin", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            else
            {
                try
                {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if
                        (BLL_Khoa.Instance.Sua(makhoa, tenkhoa, id) == true)
                        btnLamMoi.PerformClick();
                }
                catch
                {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
           ...
           string tenkhoa = txbTenKhoa.Text;
            ...
            if (MessageBox.Show("Bạn có muốn xóa khoa " + tenkhoa + "không", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
    ...
    internal class DataGirdViewCellEventArgs
    {
    }
}